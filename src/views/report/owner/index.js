...
export const Owner = () => {
    return (
        <div className='report-content-content'>
            <div className="report-content-content-header" id="item-9">
            ...
            <div className="permit-accordian-div" id="item-9-1">
                <AccordionComponent>
            ...
            <div className="permit-accordian-div" id="item-9-2">
                <AccordionComponent>
                    <AccordionItemsDirective>
            ...
            <div className="permit-accordian-div" id="item-9-3">
                <AccordionComponent>
                    <AccordionItemsDirective>
                        <AccordionItemDirective header="Association Information" content={childcomp} />
                    </AccordionItemsDirective>
                </AccordionComponent>
            </div>
        </div>
